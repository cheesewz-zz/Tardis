...
<strong id="text-orange"><a href="index.cfm?action=view.search&calendarid=<cfoutput>#calendarid#</cfoutput>">Calendar Search</a></strong> | 
</p>
<br clear="all"/><br>
...
<tr>
	...
	<tr>
		<td id="heading2">Advanced Search</td>
	</tr>
	<tr id="bg-blue1">
		<td>
		...
		<tr>
			...
			<a href="#" onClick="window.dateField=document.SearchForm.startdate_search;calendar=window.open('calendar_picker.cfm?datefield=startdate_search', 'cal', 'WIDTH=325,HEIGHT=250')"><IMG src="/tardis_calendar/images/cal.gif" width="35" height="35" border=0 align="absmiddle"></A> 
			</td>
		</tr>
		<tr>
			...
			<a href="#" onClick="window.dateField=document.SearchForm.enddate;calendar=window.open('calendar_picker.cfm?datefield=enddate_search', 'cal', 'WIDTH=325,HEIGHT=250')"><IMG src="/tardis_calendar/images/cal.gif" width="35" height="35" border=0 align="absmiddle"></A> 
			</td>
		</tr>
		<tr>
