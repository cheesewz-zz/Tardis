...
<cfif IsDefined("calendarid")>
	...
	<cfset events = session.calendarObj.getCalendarEvents(odbcfirstday,odbclastday,calendarid)>	
<cfelse>
	<cfset events = session.calendarObj.getCalendarEvents(odbcfirstday,odbclastday)>
</cfif>
...
<cfset lYearList = session.calendarObj.getCalendarYearList(calendarid)>
...
<cfset calendarid = application.secObj.encryptValue(calendarid,true,true)>
...
function goThere(theMonth){
	...
	location = 'index.cfm?action=view.calendar&calendarid=<cfoutput>#calendarid#</cfoutput>&showdate=' + gotodate;
...
<strong><a href="index.cfm?action=view.search&calendarid=<cfoutput>#calendarid#</cfoutput>">Calendar Search</a></strong> | 
</p>
<br clear="all"/><br>
...
<a href="index.cfm?action=view.calendar&calendarid=<cfoutput>#calendarid#</cfoutput>&showdate=<cfoutput>#prevprevyeardate#</cfoutput>" class="field3">
<img src="/tardis_calendar/images/bayearbk.gif" border="0" alt="Previous Year"></a>
&nbsp;&nbsp;
<a href="index.cfm?action=view.calendar&calendarid=<cfoutput>#calendarid#</cfoutput>&showdate=<cfoutput>#prevdate#</cfoutput>" class="field3">
...
&nbsp;
<a href="index.cfm?action=view.calendar&calendarid=<cfoutput>#calendarid#</cfoutput>&showdate=<cfoutput>#nextdate#</cfoutput>" class="field3">
<img src="/tardis_calendar/images/bamonthup.gif" border="0" alt="Next Month"></a>&nbsp;&nbsp;
<a href="index.cfm?action=view.calendar&calendarid=<cfoutput>#calendarid#</cfoutput>&showdate=<cfoutput>#nextnextyeardate#</cfoutput>" class="field3">
...
<tr>
	...
	<cfset thiseventid = application.secObj.encryptValue(EventID_R,true,true)>
				...
				<cfif Weekend_C NEQ 1>
					<cfif #DayOfWeekAsString(DayOfWeek(Month(datetodisplay) & '/' & DateCount & '/' & Year(datetodisplay)))# NEQ 'Saturday'
						and #DayOfWeekAsString(DayOfWeek(Month(datetodisplay) & '/' & DateCount & '/' & Year(datetodisplay)))# NEQ 'Sunday'>
							...
							<A HREF="index.cfm?action=view.event&eventid=#thiseventid#" class="#thisclass#">#Title_X#</A><br />
							[<A HREF="index.cfm?action=view.updateevent&eventid=#thiseventid#&calendarid=#calendarid#" class="#thisclass#">EDIT</A> | <A HREF="index.cfm?action=view.deleteevent&eventid=#thiseventid#&calendarid=#calendarid#" class="#thisclass#">DELETE</A>]<br /><br />
					</cfif>
				<cfelse>
					<cfif EventTypeID_R EQ 1>
						<cfset thisclass = "field2">
