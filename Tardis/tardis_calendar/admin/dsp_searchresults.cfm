...
<cfif form.searchtype IS "basic">
	<cfset qResults = session.calendarObj.basicSearch(form.allfields,form.calendarid)>
<cfelse>
	<cfset qResults = session.calendarObj.advancedSearch(form.calendarid,form.title_search,form.startdate_search,form.enddate_search,form.location_search,form.eventtype_search,form.synopsis_search,form.contact_search)>
</cfif>
...
<cfoutput query="qCalendars">
<cfif CalendarID_R IS calendarid>
	<strong id="text-orange"><a href="index.cfm?action=view.calendar">#CalendarName_X#</a></strong><cfif CurrentRow EQ 1> | </cfif>
<cfelse>
